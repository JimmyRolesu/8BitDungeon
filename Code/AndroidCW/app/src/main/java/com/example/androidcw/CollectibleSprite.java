...
public class CollectibleSprite {
    ...
    /**
     * Draws sprites for collectibles
     * @param SpriteSheet
     * @param sRows
     * @param sColumns
     */
    public CollectibleSprite(Bitmap SpriteSheet, int sRows, int sColumns) {
        b = SpriteSheet;
        rows = sRows;
        columns = sColumns;
     ...
     * @param c
     * @param collectible The collectible being drawn
     */
    public void onDraw(Canvas c, Collectible collectible) {
        x = collectible.getX();
        y = collectible.getY();
